...
adata = anndata.read("/home/datadisk/zlg/singlecell/stemcell_cycle_differentiation/mouse retinal development/mouse_retina.h5ad")
...
# 并行
Parallel(n_jobs=150)(
    delayed(path_function)(0.1, 1e-1, i)
    for i in range(N))
